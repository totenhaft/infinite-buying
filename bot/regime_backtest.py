...
REGIMES = [
    ...
    # ── 미국 기준금리 국면 (FOMC 인상 시작일 ~ 마지막 인상일 기준) ──
    ("금리인상 1999-00",   "1999-06-30", "2000-05-16", "금리인상"),
    ("금리인상 2004-06",   "2004-06-30", "2006-06-29", "금리인상"),
    ("금리인상 2015-18",   "2015-12-16", "2018-12-19", "금리인상"),
    ("금리인상 2022-23",   "2022-03-16", "2023-07-26", "금리인상"),
    ("고금리 유지 23-24",  "2023-07-27", "2024-09-17", "고금리"),
    ("전체 기간",          None,         None,         "전체"),
]
